...
Visual Solutions is a Norwegian company in the BB Visual Group\cite{group_visual_2014} Their primary business is within the integration of operations for the oil and gas industry. They have offices in Houston, US, Brighton, UK and a headquarter in Bergen, Norway.
...
One of their applications Virtual Arena\footnote{http://www.bbvisuals.com/index.php?site=2\&page=75.125} is a powerful and interactive tool that allows IP-based application sharing within collaborative sessions. Virtual Arena supports one-to-one, one-to-many and many-to-many collaborative scenarios, with support for high-performance application sharing, audio and video communication from an advanced 3D shared scene.\cite{solutions_b2|virtual_2014}
