...
The getUserMedia() API allows us to specify a list of mandatory constraints to match the needs of the applicaton as seen in Listing \ref{lst:constraints}.
...
To summarize the process of creating a peer-to-peer connection (Listing \ref{lst:p2p-webrtc}):

\begin{lstlisting}[caption={WebRTC P2P connection}, label={lst:p2p-webrtc}]
